...
public class ErrorCode extends RuntimeException {
    ...
    public static final int NO_AVAILABLE_BLOCK = 13;
    public static final int FILE_BROKEN = 14;
    public static final int INPUT_ERROR = 15;
    public static final int REMOTE_CONNECT_ERROR = 16;
    ...
    static {
        ...
        ErrorCodeMap.put(NO_AVAILABLE_BLOCK,"可能未启动相应block manager，请重试。");
        ErrorCodeMap.put(FILE_BROKEN,"文件被违规损坏，请避免对该文件操作。");
        ErrorCodeMap.put(INPUT_ERROR,"输入存在错误，请检查。");
        ErrorCodeMap.put(REMOTE_CONNECT_ERROR,"远程连接错误，请检查。");
